    ...
    <Section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-8 items-center">
        ...
        <FadeIn className="lg:col-span-1">
          <p className="text-lg md:text-xl lg:text-2xl font-bold leading-snug text-[var(--color-blue)] max-w-[200px] md:max-w-[240px]">
            {line1}
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.2} className="lg:col-span-1">
          <div className="space-y-6 text-right">
            <p className="text-lg md:text-xl lg:text-2xl font-bold leading-snug text-[var(--color-blue)]">
              {line2}
            </p>
            {credentialLine && (
