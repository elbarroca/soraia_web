      ...
      <div className="mx-auto w-full max-w-[var(--max-width)] px-[var(--space-page-x)] flex flex-col items-center justify-center">
        ...
        <div className="relative w-full" style={{ minHeight: "clamp(2.5rem, 8vw, 6rem)" }}>
          <AnimatePresence mode="wait">
            <motion.span
              key={currentIndex}
              className="absolute text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase tracking-tight text-[var(--color-ink)] leading-[1.05] text-center w-full px-4"
