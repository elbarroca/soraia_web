            ...
            <FadeIn>
              <div>
                ...
                <p className="text-[var(--color-ink-light)] leading-relaxed max-w-md">
                  Whether you&apos;re drawn to a particular piece, curious about commissioning something new, or simply want to talk about art — I read every message personally.
                </p>
                <p
                  className="text-[15px] text-[var(--color-ink-muted)] mt-3"
            ...
            <FadeIn delay={0.1}>
              <div className="space-y-5">
                ...
                <a
                  ...
                  className="flex items-start gap-3 group"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-ink-muted)] mt-1 flex-shrink-0" aria-hidden="true"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                  <div>
                    <p className="text-[10px] font-medium tracking-[0.2em] uppercase text-[var(--color-ink-muted)] mb-1">Instagram</p>
                    <p className="text-sm group-hover:underline underline-offset-4">
                      @soraianoliveira
                    </p>
                  </div>
